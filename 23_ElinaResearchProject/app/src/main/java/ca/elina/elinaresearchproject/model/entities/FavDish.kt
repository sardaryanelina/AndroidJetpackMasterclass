...
// Create a new package name as entities in the model package. After creating the entities package create data class with the entities (Dish Items) that we want to insert in the database.
